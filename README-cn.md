...
访问Grafana：<http://grafana.mysting.io>
...
访问Traefik UI：<http://traefik.mysting.io>
...
现在打开浏览器，访问http://scope.weave.mysting.io/
...
- [Kubernetes Handbook——Kubernetes中文指南/云原生应用架构实践手册](https://mysting.io/kubernetes-handbook)
